define('Configurator/Scripts/VariantsTree/VariantsTreeApplicationBase', [
	'dojo/_base/declare',
	'dojo/_base/connect',
	'Configurator/Scripts/VariantsTree/LabeledRangeSlider',
	'Configurator/Scripts/VariantsTree/VariantsTreeDataBuilder',
	'Controls/VariantsTree/VariantsTree',
	'Configurator/Scripts/VariantsTree/Print/VariantsTreePrint'
],
function(declare, connect, LabeledRangeSlider, DataBuilder, VariantsTree, VariantsTreePrint) {
	return declare(null, {
		scaleSlider: null,
		treeControl: null,
		...
		resizeTimer: null,
		dataBuilder: null,
		variantsTreePrint: null,

		constructor: function(initialParameters) {
			this.scaleSlider = new LabeledRangeSlider({
				sliderId: 'scaleSlider',
				connectId: 'variantsTreeControls', label: 'Scale:', minValue: 0.1, maxValue: 2, step: 0.02, value: 1,
			...
			this.spacingSlider = new LabeledRangeSlider({
				...
				connectId: 'variantsTreeControls', label: 'Spacing:', minValue: 180, maxValue: 400, step: 2, value: 200,
				valueFormatter: function(sliderValue) {
			...
			this.treeControl = new VariantsTree({
				connectId: 'variantsTreeContainer',
				layerVisualizationParameters: {
					'groups': {sourceMargin: 75}
				}
			});
			this.treeControlParentNode = this.treeControl.getParentNode();
			this.containerNode = document.querySelector('#variantsTreeContainer');
			this.treeControlsNode = document.querySelector('#variantsTreeControls');
			this.infoNode = document.querySelector('#variantsTreeInfo');

			this.variantsTreePrint = new VariantsTreePrint({
