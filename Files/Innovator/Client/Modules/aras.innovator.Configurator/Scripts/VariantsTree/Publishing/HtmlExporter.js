define('Configurator/Scripts/VariantsTree/Publishing/HtmlExporter', [
	'dojo/_base/declare',
	'dojo/dom-construct'
],
		...
		export: function() {
			if (!this._isExporting) {
				...
				this._uploadNodeIcons(this.dataBuilder.generationData.nodeItems).then(function() {
					...
					xmlhttp.open('POST', '../Modules/aras.innovator.Configurator/VariantTreeViewPublishing');
					xmlhttp.onreadystatechange = function() {
						if (xmlhttp.readyState === 4 && xmlhttp.status === 200) {
							...
							this._aras.saveString2File(resCallback, 'html', 'VariantsTree');
