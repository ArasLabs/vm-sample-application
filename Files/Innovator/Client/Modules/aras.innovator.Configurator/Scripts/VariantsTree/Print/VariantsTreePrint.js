define('Configurator/Scripts/VariantsTree/Print/VariantsTreePrint', [
	'dojo/_base/declare',
	'dojo/dom-construct'
],
function(declare, domConstruct) {
	return declare(null, {
		...
		buildPrintableFrame: function() {
			...
			style.innerHTML += '#variantsTreeTitle {margin-top: 10px !important}';
			style.innerHTML += '#variantsTreeInfo {top: 60px !important}';
			html.head.appendChild(style);

			var treeTitle = document.querySelector('#variantsTreeTitle');
			html.body.appendChild(this.cloneNodeWithStyle(treeTitle));
			var treeInfo = document.querySelector('#variantsTreeInfo');
			html.body.appendChild(this.cloneNodeWithStyle(treeInfo));
			var treeNode = document.querySelector('#variantsTreeContainer>svg');
