define([
	'dojo/_base/declare',
	'Configurator/Scripts/TableRuleEditor/DataModel/DataLoader',
	'Configurator/Scripts/TableRuleEditor/DataModel/ModelItemFactory',
	'Modules/aras.innovator.core.Core/Scripts/Classes/Eventable',
	'Configurator/Scripts/TableRuleEditor/DataModel/ComparableModelItem'
],
	...
	return declare([Eventable, Comparable], {
		...
		getIconPath: function(modelItem) {
			...
			if (!cachedIcon) {
				switch (itemTypeName) {
					case 'Variable':
						cachedIcon = '../images/CFGVariable.svg';
						break;
					case 'NamedConstant':
						cachedIcon = '../images/CFGNamedConstant.svg';
						break;
					default:
