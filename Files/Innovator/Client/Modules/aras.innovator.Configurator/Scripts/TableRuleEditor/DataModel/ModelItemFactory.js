...
define([
	'dojo/_base/declare',
	'Configurator/Scripts/TableRuleEditor/DataModel/ModelItem',
	'Configurator/Scripts/TableRuleEditor/DataModel/GroupedModelItem',
	'Configurator/Scripts/TableRuleEditor/DataModel/ExpressionModelItem'
],
		...
		createModelItemFromItemNode: function(targetNode, optionalParameters) {
			...
			if (targetNode) {
				...
				if (!allowedItemTypes || allowedItemTypes[itemType]) {
					var relatedItemNodes = targetNode.selectNodes('./Relationships/Item');
					var itemData = {
